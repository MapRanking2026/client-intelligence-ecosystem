...
export const NAV: NavItem[] = [
  ...
  { href: "/engine", label: "Client Intelligence Engine", glyph: "⬢", permission: "settings.manage" },
  { href: "/tasks", label: "Tasks", glyph: "☑", permission: "seo.package.read" },
  { href: "/tickets", label: "Tickets", glyph: "◈", permission: "seo.package.read" },
  ...
  { href: "/rules", label: "Rule Library", glyph: "▤", permission: "settings.manage" },
