...
export const RULE_CATALOG: RuleDef[] = [
  ...
  { key: "kpi.closed_tickets_target_pct", code: "M12.19", category: "Performance & scoring", name: "Closed Tickets KPI target", description: "Weekly closed-tickets target for Specialists/Strategists.", defaultValue: "90", unit: "%", sources: ["39011"] },
