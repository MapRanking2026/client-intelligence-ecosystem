    ...
    >
      ...
      >
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          <Link href={`/qa/${payload.client.id}`} className="rounded-2xl border border-white/8 bg-white px-4 py-4 text-sm font-semibold text-[#223554] transition hover:bg-[#d7f5ec]">
            Back to client QA history
          </Link>
          <Link href={`/monthly-touch/${payload.touch.id}`} className="rounded-2xl border border-white/8 bg-white px-4 py-4 text-sm font-semibold text-[#223554] transition hover:bg-[#d7f5ec]">
            Open Monthly Touch workspace
          </Link>
          <Link href={`/monthly-touch/${payload.touch.id}/summary`} className="rounded-2xl border border-white/8 bg-white px-4 py-4 text-sm font-semibold text-[#223554] transition hover:bg-[#d7f5ec]">
